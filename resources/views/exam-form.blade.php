...
@section('content')
    <div class="container exam-card">
        ...
        <div id="martyr_section">
            ...
            <div class="row contact-info fields">
                ...
                <div class="telephone col-md-5">
                    <div class="row">
                        <label class="col-md-4  required">Mobile No. </label>
        ...
        <label class="required">(SEE / +2 / Bachelor / Masters)</label>
        <div class="fields">
        ...
        <div class="fields">
            <div class="seven wide field">
                <input class=" {{ $errors->has('board') ? 'is-invalid' : '' }}" type="hidden" name="board[]" placeholder="Board or University" >
            </div>
            <div class="three wide field">
                <input class=" {{ $errors->has('passed_year') ? 'is-invalid' : '' }}" type="hidden" name="passed_year[]" placeholder="Passed Year" >
            </div>
            <div class="six wide field">
                <div class="two fields">
                    <div class="field">
                        <input class=" {{ $errors->has('roll_no') ? 'is-invalid' : '' }}" type="hidden" name="roll_no[]" placeholder="Percent / GPA" >
                    </div>
                    <div class="field">
                        <input class=" {{ $errors->has('division') ? 'is-invalid' : '' }}" type="hidden" name="division[]" placeholder="Division / Grade" >
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="field" id="upload_voucher">
            <label class="required">Deposit Receipt / Voucher (scanned image) / Connect IPS Receipt</label>
    ...
    <script>
        ...
        var selected_college = $("#campus").val();
            if(selected_college == '20') {
                ...
                $("#exam_centre").empty();
                $("#exam_centre").append(`"
                    <option value='Central Campus of Engineering - Surkhet'>Central Campus of Engineering - Surkhet</option>
                    <option value='Kathmandu'>Kathmandu</option>"`);
            } else {
                $(".exam_centre").hide();
            }
        ...
        $(document).ready(function() {
            ...
            $("#faculties").change(function() {
                ...
                // if(selected_id == 5) {
                    $("#levels").empty();
                //     $("#levels").append("<option value=''>Sorry registration has been closed for Engineering...</option>");
                // } else {
                ...
                if(faculty_id==7 && selected_id==1) {
                    ...
                    $(".engineer").append(`<div class="priority">
                                            ...
                                            <table class="table table-bordered ">
                                                ...
                                                <tr>
                                                    <th>Number</th>
                                                    <td><input type="number" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6"  required></td>
                                                    <td><input type="number" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6" ></td>
                                                    <td class="d-none"><input type="hidden" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6" ></td>
                                                    <td class="d-none"><input type="hidden" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6" ></td>
                                                    <td class="d-none"><input type="hidden" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6" ></td>
                                                    <td class="d-none"><input type="hidden" name="priority[]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="1" min="1" max="6" ></td>
                                                </tr>
